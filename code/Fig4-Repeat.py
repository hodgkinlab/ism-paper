...
if __name__ == "__main__":
	xlsx = pd.ExcelFile('./data/Fig4/repeat/IgG_IgE_data.xlsx')
	...
	## Save plots
	fig1.savefig('./out/Fig4/repeat/RSS.pdf', dpi=300)
	fig2.savefig('./out/Fig4/repeat/AID.pdf', dpi=300)
	figg.savefig('./out/Fig4/repeat/Iy1.pdf', dpi=300)
	fig3.savefig('./out/Fig4/repeat/IgG1.pdf', dpi=300)


	## Save results to excel
	with pd.ExcelWriter("./out/Fig4/repeat/results.xlsx", engine='xlsxwriter', options=options, mode='w') as writer:
